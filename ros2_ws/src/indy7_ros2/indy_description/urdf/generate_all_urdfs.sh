...
# List of indy types.
#
# Upstream indy7_ros2 supports the whole Neuromeka range. This repository keeps
# only indy7, the arm used in the experiment, so that the meshes it ships stay
# small. To regenerate a URDF for another arm, restore that arm's meshes and
# urdf/config directory from upstream and add its name back here.
indy_types=("indy7")
